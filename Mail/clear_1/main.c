...
void task0(void)   
{
    ...
    {
		     sendByte('A');
		//	   pint = pendMailOS(number, &readyNo, 1, INFINITEOS);        // 2
			   pint = pendMailOS(number, &readyNo, 0, INFINITEOS);			// 1
				 sendByte('a');	
			   if( pint != 0x0 )
				 {
				    sendByte('0' + *pint);
...
void task1(void)   
{
    ...
    {
		     sendByte('B');
			   pint = pendMailOS(number, &readyNo, 0, INFINITEOS);
				 sendByte('b');
			   if( pint != 0x0 )
				 {
				    sendByte('0' + *pint);
...
void task2(void)   
{
    ...
    {
		     sendByte('C');
			   pint = pendMailOS(number, &readyNo, 1, INFINITEOS);
				 sendByte('c');
			   if( pint != 0x0 )
				 {
				    sendByte('0' + *pint);
