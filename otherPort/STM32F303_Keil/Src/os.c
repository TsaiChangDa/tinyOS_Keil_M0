...
void*         RelyMargeDangerOS[GETMEMORYSIZE][3];
...
int           ItemsPendQOS[QSIZE];
char          OverflowPendQOS[QSIZE];
char          SleepPendQOS[QSIZE];
char          QOverflowOS[QSIZE];
...
char startOS(fn_ptr_t *taskName, int arraySize, int startPriority, int clock)
{ 
	  char         errorCode;
	  unsigned int topStackPointer;
    //static int s_startPriority;
    //static fn_ptr_t * taskName;
    //taskName = my_fn;
    // s_startPriority = startPriority;
